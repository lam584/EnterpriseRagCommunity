...
### 环境要求与依赖安装
- Java版本：项目使用Java 25工具链，Gradle配置中明确指定javaToolchainVersion=25、javaReleaseVersion=25。
...
## 依赖分析
后端依赖包括Spring Boot Starter Web、JPA、Security、Actuator、MySQL Connector、Flyway、Elasticsearch等；前端依赖React、TypeScript、Vite、Tailwind CSS等。Gradle配置中明确指定Java 25工具链与测试配置。
