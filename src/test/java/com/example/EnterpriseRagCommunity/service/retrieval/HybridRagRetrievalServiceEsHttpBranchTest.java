...
public class HybridRagRetrievalServiceEsHttpBranchTest {
    ...
    void postSearch_normalizesEndpoint_andSendsExpectedRequest() throws Exception {
        ...
        assertEquals("mockhttp://es/idx_posts/_search?filter_path=hits.hits._id,hits.hits._score,hits.hits._source,hits.hits.highlight", req.url().toString());
