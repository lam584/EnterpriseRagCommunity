...
public interface AdminModerationQueueService {
    ...
    AdminModerationQueueDetailDTO banUser(Long id, String reason);
    ...
    void ensureEnqueuedProfile(Long userId);
    ...
    AdminModerationQueueDetailDTO requeueToAuto(Long id, String reason, String reviewStage);

    /** 终态任务进入人工审核：重置为 HUMAN + HUMAN，并清理人工认领/锁/完成时间 */
    AdminModerationQueueDetailDTO toHuman(Long id, String reason);

    AdminModerationQueueBatchRequeueResponse batchRequeueToAuto(List<Long> ids, String reason, String reviewStage);
