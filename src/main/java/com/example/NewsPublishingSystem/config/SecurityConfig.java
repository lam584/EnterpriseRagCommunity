...
import com.example.NewsPublishingSystem.entity.Administrator; // 添加对 Administrator 实体的导入
import com.example.NewsPublishingSystem.service.AdministratorService; // 改为注入Service
