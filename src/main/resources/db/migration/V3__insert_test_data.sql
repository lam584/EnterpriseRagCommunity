...
VALUES ('9787111495482', '深入理解Java虚拟机', '周志明', '机械工业出版社', '第二版', 79.00, 4, 1, '可借阅', '2018年10月第15次印刷', 1),
       ...
       ('9787115417305', 'C++ Primer中文版', 'Stanley B. Lippman', '人民邮电出版社', '第五版', 128.00, 4, 2, '可借阅', '2018年10月第8次印刷', 1),
       ('9787115547491', '算法导论', 'Thomas H.Cormen', '人民邮电出版社', '第三版', 128.00, 4, 2, '可借阅', '2019年12月第10次印刷', 1),
       ('9787544253994', '百年孤独', '加西亚·马尔克斯', '南海出版公司', '第一版', 55.00, 1, 3, '可借阅', '2017年8月第12次印刷', 1),
       ('9787020002207', '红楼梦', '曹雪芹', '人民文学出版社', '第一版', 59.70, 1, 3, '可借阅', '2018年6月第5次印刷', 1),
       ('9787544291170', '杀死一只知更鸟', '哈珀·李', '南海出版公司', '第一版', 32.00, 1, 3, '可借阅', '2017年3月第8次印刷', 1),
       ('9787201089126', '明朝那些事儿', '当年明月', '天津人民出版社', '第一版', 358.00, 3, 4, '可借阅', '2018年2月第25次印刷', 1),
       ('9787111624837', '经济学原理', '曼昆', '机械工业出版社', '第八版', 128.00, 5, 5, '可借阅', '2020年1月第1次印刷', 1);
...
VALUES (1, 1, 1, '2023-05-01 10:00:00', '2023-05-15 16:30:00', '已归还', 0.00, 0, 0),
       ...
       (3, 2, 1, '2023-05-05 09:15:00', NULL, '借阅中', 0.00, 1, 7),
       (6, 3, 1, '2023-05-08 11:30:00', '2023-05-18 15:45:00', '已归还', 0.00, 0, 0),
       (7, 4, 1, '2023-04-20 16:00:00', NULL, '逾期', 0.00, 0, 0),
       (9, 3, 1, '2023-05-12 10:25:00', NULL, '借阅中', 0.00, 0, 0);
...
VALUES (50.00, 50.00, 0.00, '2023-05-20 14:30:00', 1, 1, '预存款'),
       (100.00, 100.00, 0.00, '2023-05-21 10:15:00', 1, 3, '预存款');
...
VALUES ('图书馆开放时间调整通知', '尊敬的读者：\n自2023年6月1日起，图书馆开放时间调整为：\n周一至周五：8:00-22:00\n周六至周日：9:00-21:00\n特此通知。', 1),
       ('新书到馆通知', '尊敬的读者：\n本馆已新增200余册各类图书，包括最新的计算机技术、文学作品等，欢迎前来借阅。', 1),
...
VALUES ('INFO', '管理员登录系统', '{"action":"login","result":"success"}', '192.168.1.100', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', 1, '2023-05-25 08:30:00'),
       ...
       ('INFO', '添加新图书', '{"action":"add_book","bookId":10,"result":"success"}', '192.168.1.101', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', 1, '2023-05-25 10:30:00'),
       ('WARNING', '尝试重置密码失败', '{"action":"reset_password","userId":5,"result":"failed","reason":"权限不足"}', '192.168.1.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', 1, '2023-05-25 11:45:00');
