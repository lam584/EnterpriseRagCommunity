                                            ...
                                            <input
                                              ...
                                              onChange={(e) =>
                                                setPriceEdits((prev) => {
                                                  ...
                                                  next[idx] = { ...next[idx], upToTokens: e.target.value };
                                                  return { ...prev, [row.model]: { ...cur, tiers: next, saving: false, ok: false } };
                                                })
                                              }
                                            />
                                          </td>
                                            ...
                                            <input
                                              ...
                                              onChange={(e) =>
                                                setPriceEdits((prev) => {
                                                  ...
                                                  if (!cur) return prev;
                                                  const next = [...cur.tiers];
                                                  next[idx] = { ...next[idx], inputCostPerUnit: e.target.value };
                                                  return { ...prev, [row.model]: { ...cur, tiers: next, saving: false, ok: false } };
                                                })
                                              }
                                            />
                                            ...
                                            <input
                                              ...
                                              onChange={(e) =>
                                                setPriceEdits((prev) => {
                                                  ...
                                                  if (!cur) return prev;
                                                  const next = [...cur.tiers];
                                                  next[idx] = { ...next[idx], outputCostPerUnit: e.target.value };
                                                  return { ...prev, [row.model]: { ...cur, tiers: next, saving: false, ok: false } };
                                                })
                                              }
                                            />
