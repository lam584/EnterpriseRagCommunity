...
export default function InteractModerationPage() {
  ...
  async function load() {
    ...
    setError(null);
    try {
      const page = await fetchNotifications({ type: 'MODERATION', page: 1, pageSize: 50 });
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">审核</h3>
        <button
          type="button"
