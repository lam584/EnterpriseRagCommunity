...
describe('moderationFallbackService', () => {
  ...
  it('getFallbackConfig covers ok and error branches', async () => {
    ...
    const { getFallbackConfig } = await import('/services/moderation/policy/moderationFallbackService');
  ...
  it('updateFallbackConfig covers csrf header, ok, and error branches', async () => {
    ...
    const { updateFallbackConfig } = await import('/services/moderation/policy/moderationFallbackService');
