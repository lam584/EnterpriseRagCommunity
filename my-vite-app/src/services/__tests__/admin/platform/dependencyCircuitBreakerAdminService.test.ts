...
describe('dependencyCircuitBreakerAdminService', () => {
  ...
  it('adminGet/updateDependencyCircuitBreakerConfig allow empty dependency string', async () => {
    ...
    const { adminGetDependencyCircuitBreakerConfig, adminUpdateDependencyCircuitBreakerConfig } = await import('/services/admin/platform/dependencyCircuitBreakerAdminService');
  ...
  it('adminUpdateDependencyCircuitBreakerConfig covers payload/reason defaults, ok, and errors', async () => {
    const { replyJsonOnce, replyOnce, lastCall } = installFetchMock();
    const { adminUpdateDependencyCircuitBreakerConfig } = await import('/services/admin/platform/dependencyCircuitBreakerAdminService');
